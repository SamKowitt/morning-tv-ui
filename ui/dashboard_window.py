...
class DashboardWindow(QMainWindow):
    ...
    def on_sports_games_loaded(self, leagues):
        ...
        # Disabled temporarily: this background worker is causing a native
        # Qt/Python crash while fetching MLB box scores during startup.
        print("Background box-score preload disabled to prevent startup crash.")
